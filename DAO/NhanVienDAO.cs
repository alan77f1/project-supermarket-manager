...
namespace DAO
{
    public class NhanVienDAO
    {
        ...
        {
            string query = "select MaNV as [Mã nhân viên],TenHienThi as [Tên nhân viên],GioiTinh as [Giới tính],DiaChi as [Địa chỉ],SDT as [SĐT] ,Quyen as [Chức vụ] from NhanVien";
